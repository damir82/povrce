...
$photos = array(
    '/pictures/portfolio1.jpg::Boranija spremna za prodaju',
    '/pictures/portfolio2.jpg::Rasad kupusa',
    '/pictures/portfolio3.jpg::Rasad crvenog kupusa',
    'photos/4.jpg',
    'photos/5.jpg'
    );
...
<html>
    ...
    <head>
        ...
        viewer.add('/pictures/portfolio1.jpg');
        viewer.add('/pictures/portfolio2.jpg');
        viewer.add('/pictures/portfolio3.jpg');
